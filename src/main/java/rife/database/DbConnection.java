...
public class DbConnection implements AutoCloseable {
    ...
    throws DatabaseException {
        try {
            ...
            var statement = connection_.createStatement();

            synchronized (this) {
                var db_statement = new DbStatement(this, statement);
    ...
    throws DatabaseException {
        try {
            ...
            var statement = connection_.createStatement(resultSetType, resultSetConcurrency);
    ...
    throws DatabaseException {
        try {
            ...
            var statement = connection_.createStatement(resultSetType, resultSetConcurrency, resultSetHoldability);
    ...
    throws DatabaseException {
        ...
        try {
            ...
            var prepared_statement = connection_.prepareStatement(sql);

            synchronized (this) {
                var db_prepared_statement = new DbPreparedStatement(this, sql, prepared_statement);
    ...
    throws DatabaseException {
        ...
        try {
            ...
            var prepared_statement = connection_.prepareStatement(sql, autoGeneratedKeys);
    ...
    throws DatabaseException {
        ...
        try {
            ...
            synchronized (this) {
                var db_prepared_statement = new DbPreparedStatement(this, query, prepared_statement);
                statements_.add(db_prepared_statement);
    ...
    throws DatabaseException {
        ...
        try {
            ...
            var sql = query.getSql();
            var prepared_statement = connection_.prepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability);
