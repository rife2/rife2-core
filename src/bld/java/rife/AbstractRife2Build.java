...
public class AbstractRife2Build extends Project {
    ...
    throws Exception {
        ...
        scope(test)
            ...
            .include(dependency("com.mysql", "mysql-connector-j", version(9,7,0)))
            .include(dependency("org.mariadb.jdbc", "mariadb-java-client", version(3,5,9)))
            ...
            .include(dependency("com.oracle.database.jdbc", "ojdbc11", version("23.26.2.0.0")));
