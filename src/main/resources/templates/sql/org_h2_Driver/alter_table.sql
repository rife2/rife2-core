...
{{b RENAME_COLUMN}}ALTER TABLE {{v TABLE/}} ALTER COLUMN {{v NAME/}} RENAME TO {{v NEW_NAME/}}{{/b}}
{{b ALTER_COLUMN_TYPE}}ALTER TABLE {{v TABLE/}} ALTER COLUMN {{v NAME/}} SET DATA TYPE {{v TYPE/}}{{/b}}
{{b ALTER_COLUMN_NULL}}ALTER TABLE {{v TABLE/}} ALTER COLUMN {{v NAME/}} SET NULL{{/b}}
{{b ALTER_COLUMN_NOTNULL}}ALTER TABLE {{v TABLE/}} ALTER COLUMN {{v NAME/}} SET NOT NULL{{/b}}
