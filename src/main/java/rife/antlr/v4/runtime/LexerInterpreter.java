...
import rife.antlr.v4.runtime.atn.ATNType;
import rife.antlr.v4.runtime.atn.LexerATNSimulator;
...
public class LexerInterpreter extends Lexer {
	...
	public LexerInterpreter(String grammarFileName, Collection<String> tokenNames, Collection<String> ruleNames, Collection<String> modeNames, ATN atn, CharStream input) {
		this(grammarFileName, VocabularyImpl.fromTokenNames(tokenNames.toArray(new String[0])), ruleNames, new ArrayList<>(), modeNames, atn, input);
	}
