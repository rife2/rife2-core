...
public class RifeConfig {
    ...
    public class CmfConfig {
        ...
        public static final String DEFAULT_SEQUENCE_CONTENT_REPOSITORY = "SEQ_CONTENT_REPOSITORY";
        public static final String DEFAULT_SEQUENCE_CONTENT_INFO = "SEQ_CONTENT_INFO";
        public static final String DEFAULT_TABLE_CONTENT_REPOSITORY = "ContentRepository";
        public static final String DEFAULT_TABLE_CONTENT_INFO = "ContentInfo";
        public static final String DEFAULT_TABLE_CONTENT_ATTRIBUTE = "ContentAttribute";
        public static final String DEFAULT_TABLE_CONTENT_PROPERTY = "ContentProperty";
        public static final String DEFAULT_TABLE_CONTENT_STORE_IMAGE = "ContentStoreImage";
        public static final String DEFAULT_TABLE_CONTENT_STORE_TEXT = "ContentStoreText";
        public static final String DEFAULT_TABLE_CONTENT_STORE_RAW_INFO = "ContentStoreRawInfo";
        public static final String DEFAULT_TABLE_CONTENT_STORE_RAW_CHUNK = "ContentStoreRawChunk";
    ...
    public class EngineConfig {
        private long continuationDuration_ = DEFAULT_CONTINUATION_DURATION;
        private int continuationPurgeFrequency_ = DEFAULT_CONTINUATION_PURGE_FREQUENCY;
        private int continuationPurgeScale_ = DEFAULT_CONTINUATION_PURGE_SCALE;
