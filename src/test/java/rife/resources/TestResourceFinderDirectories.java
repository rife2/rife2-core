...
public class TestResourceFinderDirectories {
    public static File mainResourcesPath() {
        return new File("src" + File.separator + "main" + File.separator + "resources");
    }

    public static File testResourcesPath() {
        return new File("src" + File.separator + "test" + File.separator + "resources");
    }

    public static File coreMainResourcesPath() {
        return new File("core" + File.separator + "src" + File.separator + "main" + File.separator + "resources");
    }

    public static File coreTestResourcesPath() {
        return new File("core" + File.separator + "src" + File.separator + "test" + File.separator + "resources");
    }

    @Test
    void testInstantiation() {
        ResourceFinder resource_finder1 = new ResourceFinderDirectories(testResourcesPath());
        ResourceFinder resource_finder2 = new ResourceFinderDirectories(testResourcesPath());
    ...
    ResourceFinder getResourceFinder() {
        return new ResourceFinderDirectories(mainResourcesPath(), testResourcesPath(), coreMainResourcesPath(), coreTestResourcesPath());
    }
    
    @Test
    void testGetUnknownResource() {
        var resource_finder = getResourceFinder();
