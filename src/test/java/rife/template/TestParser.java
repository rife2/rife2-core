...
public class TestParser {
    ...
    void testParseValuesLong() {
        try {
            ...
            assertNotNull(template_parsed.getBlock("BLOCK2"));
            assertNotNull(template_parsed.getBlock("BLOCK3"));
            assertEquals(template_parsed.getContent().countParts(), 21);
            ...
            assertEquals(template_parsed.getContent().getPart(5).getData(), parser_.getTemplateContent("values_long_out_content_5"));
            assertEquals(template_parsed.getContent().getPart(6).getData(), parser_.getTemplateContent("values_long_out_content_6"));
            assertEquals(template_parsed.getContent().getPart(7).getData(), parser_.getTemplateContent("values_long_out_content_7"));
            assertEquals(template_parsed.getContent().getPart(8).getData(), parser_.getTemplateContent("values_long_out_content_8"));
            assertEquals(template_parsed.getContent().getPart(9).getData(), parser_.getTemplateContent("values_long_out_content_9"));
            assertEquals(template_parsed.getContent().getPart(10).getData(), parser_.getTemplateContent("values_long_out_content_10"));
            assertEquals(template_parsed.getContent().getPart(11).getData(), parser_.getTemplateContent("values_long_out_content_11"));
            assertEquals(template_parsed.getContent().getPart(12).getData(), parser_.getTemplateContent("values_long_out_content_12"));
            assertEquals(template_parsed.getContent().getPart(13).getData(), parser_.getTemplateContent("values_long_out_content_13"));
            assertEquals(template_parsed.getContent().getPart(14).getData(), parser_.getTemplateContent("values_long_out_content_14"));
            assertEquals(template_parsed.getContent().getPart(15).getData(), parser_.getTemplateContent("values_long_out_content_15"));
            assertEquals(template_parsed.getContent().getPart(16).getData(), parser_.getTemplateContent("values_long_out_content_16"));
            assertEquals(template_parsed.getContent().getPart(17).getData(), parser_.getTemplateContent("values_long_out_content_17"));
            assertEquals(template_parsed.getContent().getPart(18).getData(), parser_.getTemplateContent("values_long_out_content_18"));
            assertEquals(template_parsed.getContent().getPart(19).getData(), parser_.getTemplateContent("values_long_out_content_19"));
            assertEquals(template_parsed.getContent().getPart(20).getData(), parser_.getTemplateContent("values_long_out_content_20"));
    ...
    void testParseValuesShort() {
        try {
            ...
            assertEquals(template_parsed.getContent().getPart(5).getData(), parser_.getTemplateContent("values_short_out_content_5"));
            assertEquals(template_parsed.getContent().getPart(6).getData(), parser_.getTemplateContent("values_short_out_content_6"));
            assertEquals(template_parsed.getContent().getPart(7).getData(), parser_.getTemplateContent("values_short_out_content_7"));
            assertEquals(template_parsed.getContent().getPart(8).getData(), parser_.getTemplateContent("values_short_out_content_8"));
            assertEquals(template_parsed.getContent().getPart(9).getData(), parser_.getTemplateContent("values_short_out_content_9"));
            assertEquals(template_parsed.getContent().getPart(10).getData(), parser_.getTemplateContent("values_short_out_content_10"));
            assertEquals(template_parsed.getContent().getPart(11).getData(), parser_.getTemplateContent("values_short_out_content_11"));
            assertEquals(template_parsed.getContent().getPart(12).getData(), parser_.getTemplateContent("values_short_out_content_12"));
            assertEquals(template_parsed.getContent().getPart(13).getData(), parser_.getTemplateContent("values_short_out_content_13"));
            assertEquals(template_parsed.getContent().getPart(14).getData(), parser_.getTemplateContent("values_short_out_content_14"));
            assertEquals(template_parsed.getContent().getPart(15).getData(), parser_.getTemplateContent("values_short_out_content_15"));
            assertEquals(template_parsed.getContent().getPart(16).getData(), parser_.getTemplateContent("values_short_out_content_16"));
            assertEquals(template_parsed.getContent().getPart(17).getData(), parser_.getTemplateContent("values_short_out_content_17"));
            assertEquals(template_parsed.getContent().getPart(18).getData(), parser_.getTemplateContent("values_short_out_content_18"));
            assertEquals(template_parsed.getContent().getPart(19).getData(), parser_.getTemplateContent("values_short_out_content_19"));
            assertEquals(template_parsed.getContent().getPart(20).getData(), parser_.getTemplateContent("values_short_out_content_20"));
