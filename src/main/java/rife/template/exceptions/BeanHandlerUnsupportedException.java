...
public class BeanHandlerUnsupportedException extends TemplateException {
    ...
    public BeanHandlerUnsupportedException(Template template, Object bean) {
        super("The template '" + template.getClass().getName() + "' doesn't support the handling of bean values. This was attempted for bean '" + bean + "'" + (bean == null ? "." : " with class '" + bean.getClass().getName() + "'."));
