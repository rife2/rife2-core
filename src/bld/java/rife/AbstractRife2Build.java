...
public class AbstractRife2Build extends Project {
    ...
    throws Exception {
        ...
        scope(test)
            ...
            .include(dependency("org.postgresql", "postgresql", version(42,7,7)))
            .include(dependency("com.mysql", "mysql-connector-j", version(9,3,0)))
            .include(dependency("org.mariadb.jdbc", "mariadb-java-client", version(3,5,4)))
            ...
            .include(dependency("com.oracle.database.jdbc", "ojdbc11", version("23.8.0.25.04")));
