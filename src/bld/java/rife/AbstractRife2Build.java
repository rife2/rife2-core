...
public class AbstractRife2Build extends Project {
    ...
    throws Exception {
        ...
        scope(test)
            ...
            .include(dependency("org.postgresql", "postgresql", version(42,7,13)))
            .include(dependency("com.mysql", "mysql-connector-j", version(26,7,0)))
            .include(dependency("org.mariadb.jdbc", "mariadb-java-client", version(3,5,10)))
            ...
            .include(dependency("com.oracle.database.jdbc", "ojdbc11", version("23.26.3.0.0")));
